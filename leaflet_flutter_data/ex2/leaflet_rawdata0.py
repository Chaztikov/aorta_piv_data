...
for idx, fname0 in enumerate(fnames[3:]):
    ...
    ipeaks = scipy.signal.find_peaks(y0, height=None, threshold=None, distance=None, prominence=None, width=None, wlen=None, rel_height=0.5, plateau_size=None)
    ipeaks = ipeaks[0]
