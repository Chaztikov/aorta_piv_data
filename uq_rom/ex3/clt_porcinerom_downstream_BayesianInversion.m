...
%% 4 - MEASUREMENT DATA
%
% Because the lynx and Pout populations have different discrepancy options, 
% the measurement data is stored in two different data structures:  
myData(1).y = Data.Pout'/1000; %in 1000
